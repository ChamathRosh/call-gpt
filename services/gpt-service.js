...
// Adjusted to correctly access the function within the imported module
const availableFunctions = {};
tools.forEach((tool) => {
  const functionName = tool.function.name;
  const functionModule = require(`../functions/${functionName}`);
  availableFunctions[functionName] = functionModule[functionName];
});
